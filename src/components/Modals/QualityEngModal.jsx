    ...
    >
      <Box sx={style}>
        ...
        <Typography id="modal-description">
          ...
          I worked as part of the Course Automation Team, which was responsible for creating and running automated tests that served as the main aspect of integration and regression testing for course and component releases. 
          For these automated tests we mainly used Cypress, creating E2E suites that simulated user flow to test the quality and security of both courses and components. 
          We also used tools like CircleCI and GitHub Actions to run these tests for CI/CD, and Applitools for visual assertion checks. In order to 
        ...
        <Typography id="qe-modal-note">
          (Note: The use of cy.wait in the recording is for demonstration purposes only &mdash; to prevent Cypress from clicking through too quickly. Typically assertions would be used there for loading and state checking.)
        </Typography>
      </Box>
    </Modal>
  );
